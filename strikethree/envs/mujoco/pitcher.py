...
class PitcherEnv(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        self,
        forward_reward_weight=30.0,
        ctrl_cost_weight=0.1,
        healthy_reward=10.0,
        releasepoint_reward_weight=30.0,
        time_reward_weight=50.0,
        strikezone_reward_weight=150.0,
        proximity_reward_weight=50.0,
